...
export default function Analytics() {
  ...
  return (
    <Layout title="Analytics" subtitle="Track your business performance">
      <div className="space-y-6">
        {/* Welcome Section */}
        <div className="bg-white rounded-xl overflow-hidden shadow-sm mb-4 sm:mb-6 border border-gray-100">
          <div className="p-4 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Financial Overview</h2>
              <p className="text-gray-500 mt-1 text-sm sm:text-base">Track revenue, expenses, and performance metrics for your business.</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              ...
              <button className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center justify-center text-sm transition-colors shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-4 sm:mb-6">
          {/* Total Revenue */}
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col hover:shadow-md transition-shadow">
            ...
            <div className="mt-4">
              <h3 className="text-2xl sm:text-3xl font-bold">{formatCurrency(totalRevenue)}</h3>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col hover:shadow-md transition-shadow">
            ...
            <div className="mt-4">
              <h3 className="text-2xl sm:text-3xl font-bold">{formatCurrency(financialData.annualSummary.netProfit)}</h3>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col hover:shadow-md transition-shadow">
            ...
            <div className="mt-4">
              <h3 className="text-2xl sm:text-3xl font-bold">{formatCurrency(totalCommission)}</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100">
            ...
            <div className="h-64 sm:h-80 relative overflow-x-auto">
              <div className="absolute inset-0 flex items-end min-w-[600px] lg:min-w-0">
                {financialData.monthlyRevenue.map((month, index) => (
                  <div key={index} className="flex-1 flex flex-col items-center">
                    {/* Actual revenue bar */}
                    <div className="relative w-full flex flex-col items-center">
                      <div
                        className="w-6 sm:w-8 bg-gradient-to-t from-blue-500 to-blue-400 rounded-t-md"
                        style={{ 
                    ...
                    <span className="text-[10px] sm:text-xs text-gray-500 mt-2">{month.month}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100">
            ...
            <div className="mt-6 sm:mt-8">
              <div className="h-32 sm:h-40 w-32 sm:w-40 mx-auto relative">
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100">
            ...
            <div className="space-y-4">
              {financialData.agentPerformance.map((agent, index) => (
                <div key={index} className="border border-gray-100 rounded-lg p-3 sm:p-4 hover:bg-gray-50 transition-colors">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center">
                      <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-blue-600 text-white flex items-center justify-center font-medium mr-3">
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100">
            ...
            <div className="space-y-4">
              {financialData.salesByLocation.map((location, index) => (
                <div key={index} className="flex items-center justify-between">
                  <div className="flex items-center">
                    <div className={`p-2 rounded-md bg-blue-${100 + index * 100} text-blue-${500 + index * 100}`}>
                      <Building size={16} />
                    </div>
                    <div className="ml-3">
            ...
            <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-100">
              <div className="w-full bg-gray-100 h-6 sm:h-8 rounded-lg overflow-hidden flex">
                {financialData.salesByLocation.map((location, index) => (
                  <div 
                    key={index}
              ...
              <tbody className="divide-y divide-gray-100">
                {financialData.topProperties.map((property, index) => (
                  <tr key={index} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-3 sm:px-4 py-4 whitespace-nowrap font-medium text-gray-900">
