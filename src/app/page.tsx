...
export default function Home() {
  ...
  return (
    <Layout title="Dashboard" subtitle="Welcome back, Agent">
      {/* Welcome Section */}
      <div className="bg-white rounded-xl overflow-hidden shadow-sm mb-6 border border-gray-100">
        <div className="p-4 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Good Morning, Aditya!</h2>
            <p className="text-gray-500 mt-1">Here's what's happening with your properties today.</p>
          </div>
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
            <button className="w-full sm:w-auto px-4 py-2 border border-gray-200 rounded-lg text-gray-700 hover:bg-gray-50 flex items-center justify-center text-sm transition-colors">
              <Calendar size={16} className="mr-2" />
              View Calendar
            </button>
            <button className="w-full sm:w-auto px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center justify-center text-sm transition-colors shadow-sm">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          ...
          <div className="space-y-4">
            {recentClients.map(client => (
              <div key={client.id} className="p-4 border border-gray-100 rounded-xl hover:bg-gray-50 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="flex items-center mt-1 flex-wrap gap-2">
                      ...
                      <span className="text-xs text-gray-500">{client.preferredLanguage}</span>
                    </div>
                  </div>
                </div>
