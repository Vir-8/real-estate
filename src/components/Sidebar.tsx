...
export default function Sidebar({ isOpen = false, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div 
        className={`
          bg-white border-r border-gray-200 min-h-screen z-40
          ${isMobile 
            ? `fixed top-0 left-0 transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`
            : 'relative'
          }
          ${collapsed ? 'w-20' : 'w-72'} 
